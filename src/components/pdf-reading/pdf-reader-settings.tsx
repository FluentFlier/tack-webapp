    ...
    <>
      ...
      <main className="min-h-screen p-8" style={styleBackgroundColorDict}>
        ...
        <ul className="flex flex-col gap-2 items-start" style={styleTextColorDict}>
          ...
          <button onClick={toggleAIFullDocumentSummary}>AI full document summary (appears above document&apos;s content) <span id="toggleAIFullDocumentSummaryStatusSpan">{getAIFullDocumentSummaryStatus()}</span></button>
