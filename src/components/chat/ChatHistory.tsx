...
export function ChatHistory({
    ...
    return (
      <div className="flex flex-1 items-center justify-center p-8">
        <div className="text-center max-w-md">
          <h2 className="app-chat-welcome text-3xl mb-3">Welcome to Tack</h2>
          ...
          <p className="app-chat-ai-note">
            Note: AI features may make mistakes and provide incorrect information — always verify important details.
          </p>
        </div>
      </div>
    );
  ...
  return (
    ...
    >
      ...
      {loading && !streaming && (
        <div className="app-chat-thinking flex gap-3 px-6" role="status">
          <div className="app-msg__avatar--bot flex shrink-0 items-center justify-center rounded-full" aria-hidden="true" />
